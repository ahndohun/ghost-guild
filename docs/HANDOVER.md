...
0. **[보드 직접 리뷰 2026-07-10~11] 컨셉 정합 복원 2건 — 현재 최우선.** ① 클래스 개성: `docs/plans/class-identity-plan.md` (진단 6건·페이즈 P1~P5·블라인드 테스트 게이트) ② 적·스테이지 콜로세움화: `docs/plans/colosseum-bestiary-plan.md` (3막 프로그램 콘셉트·리스킨 A안은 sim 무변경). 두 계획의 파일 소유권이 분리돼 있어 병렬 실행 가능 — 편성 권고는 bestiary-plan §4.
1. §3의 진행 중 3건.
