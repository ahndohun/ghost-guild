...
const spriteDefinitions = {
  ...
  // Bald robe monk — orange-brown robe, dark sash, bare fists
  heroMonk: {
    palette: {
      o: outline,
      r: "#c98a4b",
  ...
  // Wide-brim gambler — purple vest, gold trim, dice in hand
  heroGambler: {
    palette: {
      o: outline,
      h: "#6b3a9e",
...
const spriteCache: Readonly<Record<SpriteId, Sprite>> = {
  ...
  heroMonk: buildSprite(spriteDefinitions.heroMonk),
  heroGambler: buildSprite(spriteDefinitions.heroGambler),
