...
export const perkDefinitions: Record<TemperamentId, readonly PerkDefinition[]> = {
  berserker: [
    ...
    },
    {
      ...
      choice: "b",
      name: "Iron Skin",
      effect: "Contact damage taken -20%.",
    },
    {
  ...
  survivor: [
    ...
    },
    {
      ...
      choice: "a",
      name: "Last Line",
      effect: "Contact damage taken -15% while fleeing.",
    },
    {
      ...
      choice: "b",
      name: "Second Wind",
      effect: "Max HP passives are 20% stronger.",
    },
    {
      id: "survivorOutlast",
      tier: 3,
    ...
    },
    {
      ...
      choice: "b",
      name: "Enduring Pace",
      effect: "Speed passives are 25% stronger.",
    },
  ],
};
